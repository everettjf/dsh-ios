...
for module in AgentRuntime AgentProviders AgentTools AgentStorage AgentAppleTools AgentMCP AgentLinuxGuest; do
...
for product in AgentRuntime AgentProviders AgentTools AgentStorage AgentAppleTools AgentMCP AgentLinuxGuest; do
